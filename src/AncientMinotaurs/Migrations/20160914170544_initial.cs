        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pathways_Rooms_StartId",
                        column: x => x.StartId,
                        principalTable: "Rooms",
                        principalColumn: "RoomId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Pathways_Rooms_EndId",
                        column: x => x.EndId,
                        principalTable: "Rooms",
                        principalColumn: "RoomId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TreasureId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ItemId = table.Column<int>(nullable: false),
                    RoomId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Treasures_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Treasures_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "RoomId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Loots", x => x.LootId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pathways_StartId",
                table: "Pathways",
                column: "StartId");

            migrationBuilder.CreateIndex(
                name: "IX_Pathways_EndId",
                table: "Pathways",
                column: "EndId");


            migrationBuilder.CreateIndex(
                name: "IX_Treasures_ItemId",
                table: "Treasures",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Treasures_RoomId",
                table: "Treasures",
                column: "RoomId");
